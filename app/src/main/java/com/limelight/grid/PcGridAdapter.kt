...
class PcGridAdapter(
    ...
    private fun updateOverlayIP(parentView: View, details: ComputerDetails) {
        ...
        if (details.activeAddress != null) {
            ...
            ipView.text = details.localAddress!!.address
        } else if (details.ipv6Address != null) {
            ipView.text = details.ipv6Address!!.address
        } else if (details.manualAddress != null) {
            ipView.text = details.manualAddress!!.address
        } else if (details.remoteAddress != null) {
            ipView.text = details.remoteAddress!!.address
        } else {
