...
class GameMenu(
    ...
    private fun rebuildAndReplaceMenu() {
        ...
        menuStack.clear()
        customView.findViewById<TextView>(R.id.customTitleTextView)?.text = getString(R.string.game_menu)
    ...
    private fun showMenu() {
        ...
        showMenuDialog(getString(R.string.game_menu), normalOptions.toTypedArray(), superOptions.toTypedArray())
    }
